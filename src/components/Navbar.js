      ...
      <div className='container w-100'>
        <div className='brand-and-toggler flex flex-between w-100'>
          ...
          <div className='navbar-btns flex'>
            ...
            <Link to='/Login'className='btn-design'><button >Login</button></Link>
            <Link to='/Admin'className='btn-design'><button >Admin</button></Link>
            <Link to='/Video'className='btn-design'><button >Free Videos</button></Link>
